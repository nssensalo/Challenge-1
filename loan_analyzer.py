...
print(f" The total number of loans: {total_number_of_loans}")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
total_sum_of_loans = sum(loan_costs)
print(f" The toal sum of loans: ${total_sum_of_loans} ")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = total_sum_of_loans/total_number_of_loans
...
print(f"This is the remaining months: {remaining_months}")
...
#   HINT: Present Value = Future Value / (1 + Discount_Rate/12) ** remaining_months
def the_new_loan(future_value,remaining_months, annual_discount_rate):
    present_value = future_value/(1 +.2/12)** remaining_months
